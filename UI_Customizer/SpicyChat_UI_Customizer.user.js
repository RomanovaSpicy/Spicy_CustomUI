...
(function() {
    ...
    const themes = {
        'coastal_mist': {
            ...
            css: `
                :root { --cm-bg-0: #1A1D23; --cm-bg-1: #21252E; --cm-bg-2: #2A303C; --cm-bg-3: #384050; --cm-text-main: #E0E5F0; --cm-text-italic: #C3A6D5; --cm-text-quote: #88C0D0; --cm-text-sender: #9EB0C7; --cm-accent: #81A1C1; --cm-accent-hover: #8FBCBB; --cm-border: #3E485A; --cm-border-focus: #5E81AC; --cm-shadow-heavy: rgba(0, 0, 0, 0.4); --cm-shadow-medium: rgba(0, 0, 0, 0.25); --cm-shadow-light: rgba(0, 0, 0, 0.15); }
                ...
                [data-ui-component="BotMessageContainer"], [data-ui-component="ChatHeroInnerContainer"] { background-color: var(--cm-bg-2) !important; }
                [data-ui-component="UserMessageBackgroundContainer"] { background-color: var(--cm-bg-1) !important; }
                ...
                [data-ui-component="MessageTextSpan"] { color: var(--cm-text-main) !important; line-height: inherit !important; }
                [data-ui-component="MessageTextSpan"] > em { color: var(--cm-text-italic) !important; font-style: italic !important; font-weight: 500; }
                [data-ui-component="MessageTextSpan"] > q { color: var(--cm-text-quote) !important; font-style: italic !important; opacity: 1; background-color: rgba(136, 192, 208, 0.08); border-left: 3px solid rgba(136, 192, 208, 0.5); padding: 0.1em 0.6em; display: inline-block; margin: 0.15em 0; border-radius: 0 4px 4px 0; }
        ...
        'librarium_dusk_dark': {
            ...
            css: `
                ...
                [data-ui-component="BotMessageContainer"], [data-ui-component="ChatHeroInnerContainer"] { background-color: var(--ldd-bg-2) !important; }
                [data-ui-component="UserMessageBackgroundContainer"] { background-color: var(--ldd-bg-1) !important; }
                ...
                [data-ui-component="MessageTextSpan"] { color: var(--ldd-text-main) !important; line-height: inherit !important; }
                [data-ui-component="MessageTextSpan"] > em { color: var(--ldd-text-italic) !important; font-style: italic !important; font-weight: 500; }
                [data-ui-component="MessageTextSpan"] > q { color: var(--ldd-text-quote) !important; font-style: italic !important; opacity: 1; background-color: rgba(160, 184, 168, 0.1); border-left: 3px solid rgba(160, 184, 168, 0.5); padding: 0.1em 0.6em; display: inline-block; margin: 0.15em 0; border-radius: 0 4px 4px 0; }
                ...
                [data-ui-component="BotMessageRateButton"][aria-label*='Star-button'].opacity-100 svg { fill: #E8B878 !important; stroke: #D4A06A !important; }
                [data-ui-component="ChatInputBarContainer"] { background-color: transparent !important; border-top: none !important; padding: 5px 10px 15px 10px !important; }
                [data-ui-component="ChatInputBarInnerContainer"] { padding: 0 !important; }
        ...
        'sakura_dreams_night': {
            ...
            css: `
                :root { --sdn-bg-0: #1E1C2B; --sdn-bg-1: #2A283A; --sdn-bg-2: #353248; --sdn-bg-3: #45415A; --sdn-text-main: #EAE6F5; --sdn-text-italic: #F8A0C4; --sdn-text-quote: #A0D8C0; --sdn-text-sender: #A8A0B8; --sdn-accent-pink: #E888AE; --sdn-accent-pink-hover: #F0A0C0; --sdn-accent-green: #8FBC8F; --sdn-border: #45415A; --sdn-border-focus: #E888AE; --sdn-shadow-heavy: rgba(0, 0, 0, 0.5); --sdn-shadow-medium: rgba(0, 0, 0, 0.3); --sdn-shadow-light: rgba(0, 0, 0, 0.2); --sdn-texture: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100"><path d="M50 0 C 50 0, 0 50, 50 100 C 100 50, 50 0, 50 0 Z" fill="%23${'EAE6F5'.substring(1)}" opacity="0.02" transform="rotate(45 50 50) scale(1.5)" /></svg>'); }
                ...
                [data-ui-component="BotMessageContainer"], [data-ui-component="ChatHeroInnerContainer"] { background-color: var(--sdn-bg-2) !important; }
                [data-ui-component="UserMessageBackgroundContainer"] { background-color: var(--sdn-bg-1) !important; }
                ...
                [data-ui-component="MessageTextSpan"] { color: var(--sdn-text-main) !important; line-height: inherit !important; }
                [data-ui-component="MessageTextSpan"] > em { color: var(--sdn-text-italic) !important; font-style: italic !important; font-weight: 500; }
                [data-ui-component="MessageTextSpan"] > q { color: var(--sdn-text-quote) !important; font-style: italic !important; opacity: 1; background-color: rgba(160, 216, 192, 0.1); border-left: 3px solid rgba(160, 216, 192, 0.5); padding: 0.1em 0.6em; display: inline-block; margin: 0.15em 0; border-radius: 0 4px 4px 0; }
                ...
                [data-ui-component="BotMessageRateButton"][aria-label*='Star-button'].opacity-100 svg { fill: #FFD700 !important; stroke: #DAA520 !important; }
                 [data-ui-component="ChatInputBarContainer"] { background-color: transparent !important; border-top: none !important; padding: 5px 10px 15px 10px !important; }
                 [data-ui-component="ChatInputBarInnerContainer"] { padding: 0 !important; }
        ...
        'golden_sands_twilight': {
            ...
            css: `
                ...
                [data-ui-component="BotMessageContainer"], [data-ui-component="ChatHeroInnerContainer"] { background-color: var(--gst-bg-2) !important; }
                [data-ui-component="UserMessageBackgroundContainer"] { background-color: var(--gst-bg-1) !important; }
                ...
                [data-ui-component="ChatHeroInnerContainer"] { background: linear-gradient(145deg, var(--gst-bg-2), var(--gst-bg-1)); border-color: var(--gst-border) !important; box-shadow: 0 4px 10px var(--gst-shadow-medium); }
                 ...
                 [data-ui-component="MessageTextSpan"] { color: var(--gst-text-main) !important; line-height: inherit !important; }
                 [data-ui-component="MessageTextSpan"] > em { color: var(--gst-text-italic) !important; font-style: italic !important; font-weight: 500; }
                 [data-ui-component="MessageTextSpan"] > q { color: var(--gst-text-quote) !important; font-style: italic !important; opacity: 1; background-color: rgba(136, 176, 168, 0.1); border-left: 3px solid rgba(136, 176, 168, 0.5); padding: 0.1em 0.6em; display: inline-block; margin: 0.15em 0; border-radius: 0 4px 4px 0; }
                 ...
                 [data-ui-component="BotMessageRateButton"][aria-label*='Star-button'].opacity-100 svg { fill: var(--gst-accent-copper) !important; stroke: #A86442 !important; }
                 [data-ui-component="ChatInputBarContainer"] { background-color: transparent !important; border-top: none !important; padding: 5px 10px 15px 10px !important; }
                 [data-ui-component="ChatInputBarInnerContainer"] { padding: 0 !important; }
        ...
        'ronin_red': {
            ...
            css: `
                :root { --rr-bg-0: #0A0A0C; --rr-bg-1: #121317; --rr-bg-2: #1C1E22; --rr-bg-3: #282A30; --rr-text-main: #F8F9FA; --rr-text-italic: #FF87A7; --rr-text-quote: #87CEFA; --rr-text-sender: #9098A8; --rr-accent-red: #F03E3E; --rr-accent-red-hover: #FF5C5C; --rr-accent-red-active: #D93434; --rr-border: #34363B; --rr-border-focus: #F03E3E; --rr-shadow-heavy: rgba(0, 0, 0, 0.6); --rr-shadow-medium: rgba(0, 0, 0, 0.4); --rr-shadow-light: rgba(0, 0, 0, 0.25); --rr-red-glow: 0 0 10px rgba(240, 62, 62, 0.5); }
                ...
                [data-ui-component^="SideNav"] button:hover svg { stroke: #FFFFFF !important; }
                [data-ui-component="BotMessageContainer"], [data-ui-component="ChatHeroInnerContainer"] { background-color: var(--rr-bg-2) !important; }
                [data-ui-component="UserMessageBackgroundContainer"] { background-color: var(--rr-bg-1) !important; }
                [data-ui-component="BotMessageContainer"], [data-ui-component="UserMessageBackgroundContainer"], [data-ui-component="ChatHeroInnerContainer"] { border: 1px solid var(--rr-border) !important; border-radius: 4px !important; padding: 1rem 1.3rem !important; margin-bottom: 1rem !important; box-shadow: 0 2px 5px var(--rr-shadow-light); transition: box-shadow 0.2s ease, border-color 0.2s ease, transform 0.1s ease; }
                ...
                [data-ui-component="MessageTextSpan"] { color: var(--rr-text-main) !important; line-height: inherit !important; }
                [data-ui-component="MessageTextSpan"] > em { color: var(--rr-text-italic) !important; font-style: italic !important; font-weight: 500; }
                [data-ui-component="MessageTextSpan"] > q { color: var(--rr-text-quote) !important; font-style: italic !important; opacity: 1; background-color: rgba(135, 206, 250, 0.1); border-left: 3px solid rgba(135, 206, 250, 0.5); padding: 0.1em 0.6em; display: inline-block; margin: 0.15em 0; border-radius: 0 4px 4px 0; }
    ...
    let logoElement, popupElement, dynamicStyleElement, themeStyleElement, backgroundStyleElement,
        settingsView, themesView, fontSlider, fontValue, themeDisplay,
    ...
    const popupHTML = `
        <div id="${VIEW_SETTINGS_ID}" style="display: block;">
            ...
            <div class="customizer-footer"> <button id="${RESET_BTN_ID}" class="customizer-button secondary">Reset Font</button> </div>
        </div>
    ...
    async function loadSettings() {
        ...
        } catch (e) { console.error("Error loading settings:", e); currentThemeKey = DEFAULT_THEME_KEY; currentFontSize = DEFAULT_FONT_SIZE; customBackgroundUrl = DEFAULT_BACKGROUND_URL; }
    }
    ...
    async function initialize() {
        ...
        try {
            ...
            if (!settingsView || !themesView || !fontSlider || !fontValue || !themeDisplay || !changeThemeBtn || !resetBtn || !themeListContainer || !backBtn || !backgroundUrlInput || !applyBgBtn || !resetBgBtn) { throw new Error("GUI elements missing after creation!"); }
